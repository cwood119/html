(function() {
    ...
    /* @ngInject */
    function alertsController($http, $mdDialog, $location, $document, $timeout, $mdToast, $interval, $window) {
        var vm = this;
        // Get data
        ...
        vm.openVitals = function (e, symbol) {
            $mdDialog.show({
                ...
                controllerAs: 'modal',
                templateUrl: 'app/air/alerts/dialogs/vitals-dialog.tmpl.html',            
        ...
        vm.openHeadlines = function (e, symbol) {
            $mdDialog.show({
                ...
                controllerAs: 'modal',
                templateUrl: 'app/air/alerts/dialogs/headlines-dialog.tmpl.html',            
                parent: angular.element($document.body),
                targetEvent: e
            });
        };
        ...
        vm.openFilters = function (e) {
            $mdDialog.show({
                ...
                templateUrl: 'app/air/alerts/dialogs/filters-dialog.tmpl.html',
                parent: angular.element($document.body),
                targetEvent: e
            });
        };
