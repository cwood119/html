(function() {
    ...
    /* @ngInject */
    function watchlistController($http, $mdDialog, $location, $document, $timeout, $mdToast, $interval, $window) {
        var vm = this;
        // Get data
        $http.get('app/air/watchlist/data/data.json?ts='+new Date().getTime())
        ...
        vm.openVitals = function (e, symbol) {
            $mdDialog.show({
                ...
                controllerAs: 'modal',
                templateUrl: 'app/air/watchlist/dialogs/vitals-dialog.tmpl.html',            
        ...
        vm.openHeadlines = function (e, symbol) {
            $mdDialog.show({
                ...
                controllerAs: 'modal',
                templateUrl: 'app/air/watchlist/dialogs/headlines-dialog.tmpl.html',            
                parent: angular.element($document.body),
                targetEvent: e
            });
        };
        ...
        vm.openFilters = function (e) {
            $mdDialog.show({
                ...
                templateUrl: 'app/air/watchlist/dialogs/filters-dialog.tmpl.html',
                parent: angular.element($document.body),
                targetEvent: e
            });
        };
