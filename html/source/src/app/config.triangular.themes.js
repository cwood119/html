(function() {
    ...
    function themesConfig ($mdThemingProvider, triThemingProvider, triSkinsProvider) {
        ...
        var triCyanMap = $mdThemingProvider.extendPalette('light-blue', {
            'contrastDefaultColor': 'light',
        ...
        triSkinsProvider.skin('light-blue-cloud', 'Cyan Cloud')
        .sidebarTheme('light-blue')
        .toolbarTheme('light-blue-white')
        .logoTheme('light-blue')
         ...
         *  SET DEFAULT SKIN
         */
        triSkinsProvider.setSkin('light-blue-cloud');
    }
})();
