(function() {
    'use strict';
    angular
        .module('app.air.ecal-snapshot')
        .controller('ecalSnapshotController', ecalSnapshotController);

    /* @ngInject */
    function ecalSnapshotController($http, $mdDialog, $location, $document, $timeout, $interval, $window, $mdSidenav, $scope, ecalSnapshotService, API_CONFIG, filterFilter) {
        var vm = this;

        // Page Variables
        vm.activate = function(){activate();};
        vm.currentPath = $location.path();
        vm.layout = 'datepicker';
        ...
        function getEcalData(API_CONFIG, d, today) {
            return ecalSnapshotService.getData(API_CONFIG, d, today)
                .then(function(data) {
                    return data;
                });
        }
        ...
        function getHeadlines(symbol) {
            return ecalSnapshotService.getHeadlines(symbol)
                .then(function(data) {
                    return data;
                });
        }
        ...
        function getVitals(symbol) {
            return ecalSnapshotService.getVitals(symbol)
                .then(function(data) {
                    return data;
                });
        }
        ...
        function getBulkQuotes(allSymbols) {
            return ecalSnapshotService.getBulkQuotes(allSymbols)
                .then(function(data) {
                    return data;
                });
        }
        ...
        function getSymbolData(s,id,w,ts,av) {
            return ecalSnapshotService.getSymbolData(s,id,w,ts,av)
                .then(function(data) {
                    var announce;
                    var announceDay;
